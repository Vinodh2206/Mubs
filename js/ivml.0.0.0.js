...
angular
    .module('ivml', ['ivml.chart', 'ngCookies'])
    .run(run);
...
angular.module('ivml.chart', ['ngCookies'])
    .directive('lineGroup', function ($timeout,$rootScope) {
        return {
            restrict: 'E',
    ...
    .directive('bars', function ($timeout, $rootScope) {
        return {
            restrict: 'E',
...
/*ivml.visualElements.Bars.$inject = ['chartController', 'barController', '$timeout', '$cookieStore', '$rootScope'];
    function Bars(chartController, barController, $timeout, $cookieStore, $rootScope) {*/
    
    ivml.visualElements.Bars = function Bars(chartController,                           barController, $timeout, $cookieStore, $rootScope) {
    ...
    var Bars = {
        ...
        attributes: {
            ...
            fillOpacity: 10, //@i fill opacity of bar
            stroke: null, //@i color of the bar's outline
            strokeWidth: 10, //@i stroke width of the bar's line
            strokeOpacity: 10,  //@i opacity of the bar's outline
            thickness: 50 //@i the bar's thickness (size parallel to the dependent dimension)
        },
        accessors: {
...
//    $cookieStore.put('xaxis_length',xaxis_length);
    ...
    /*if(xaxis_length <= 3){
        ...
        Bars.attributes.thickness = 50;
        console.log("Bar thickness: "+Bars.attributes.thickness);
    }*/
